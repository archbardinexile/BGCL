...
Contritus, the easternmost region, is broken by the far-reaching fjords and archipelagos of the [Manyshells](#the-manyshells). To the south-east, the enormous jungle [earthmote](getting-started#earthmotes) [Mallia](#mallia) appears to drain the sea with curtains of vines that veil its shores.
