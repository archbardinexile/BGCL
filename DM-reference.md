...
- **Multiattack.** The chakram returns to your hand immediately after it is used to make a ranged attack.
...
- **Unarmored Defense.** AC = 10 + Dex mod + Wis mod (already included).
